...
export interface ReactOptions<
  P extends {},
  T extends FunctionComponent<P> | ComponentClass<P> | ((props: P) => JSX.Element),
> {
  type: T;
...
export interface Options<
  P extends {} = any,
  T extends FunctionComponent<P> | ComponentClass<P> | ((props: P) => JSX.Element) = any,
> {
...
> {
  ...
  >({ type, props, children = "" }: ReactOptions<P, T>) {
    ...
    const wrappers =
      typeof this.options.wrappers === "function"
  ...
  protected wrapWithProviders(
    ...
    return wrappers.reduceRight(
      (child, wrapper) => React.createElement(wrapper.type, wrapper.props || null, child),
      component
    );
  }
