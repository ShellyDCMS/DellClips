...
export class VideoCardDriver extends BaseTestDriver<VideoCardDriverProps> {
  ...
  when = {
    ...
    clickDeleteMenuItem: () => this.helper.when.click("delete-menu-item"),
    clickDeleteCancel: () => this.helper.when.click("delete-cancel-button"),
    clickDeleteConfirm: () => this.helper.when.click("delete-confirm-button"),
